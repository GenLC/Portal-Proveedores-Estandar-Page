					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Portal Proveedores Estandar",
									"targetURL": "#ppeppe-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"ppeppe-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ppe.ppe",
									"url": sap.ui.require.toUrl("ppe/ppe")
								}
							}
						}
					}
